#!/usr/bin/env python
""" Compute concordance correlation coefficient between simulated and empirical effective frequency

This script is used to compute the concordance correlation coefficient between simulated and empirical effective frequency.


Usage
-----
    python 40_analysis_ef_ccc.py "simulation_configuration_path" process_id
...
if intrinsic_frequency == 10:
    ...
    ef_emp = np.load(os.path.join(data_path, f"hcp_meg/avg_effective_frequency_gamma_IF.npy"))
