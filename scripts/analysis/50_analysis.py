#!/usr/bin/env python
""" CONTROL - Detect singularities in cortical network simulations on Schaefer parcellation
...
# compute angular similarity
angular_similarity_div_rh = compute_angular_similarity(phase_grad_rh, div_template_rh, neighbours_faces_rh, boundary_mask_rh)
...
for pt in range(n_permutations):
    ...
    # compute angular similarity
    angular_similarity_div_shuffle_lh = compute_angular_similarity(phase_grad_shuffle_lh, div_template_lh, neighbours_faces_lh, boundary_mask_lh)
...
for pt in range(n_permutations):
    ...
    # compute angular similarity
    angular_similarity_div_shuffle_rh = compute_angular_similarity(phase_grad_shuffle_rh, div_template_rh, neighbours_faces_rh, boundary_mask_rh)
