...
via the structural connectome inferred from HCP subjects based on the Schaefer et al. (2018) parcellation.

Usage
-----
    python 30_simulation.py "configuration/your_configuration_file.yaml" simulation_idx
...
# save data
np.save(os.path.join(data_path, f"30_simulations/30_simulation_{simulation_id}.npy"), phase)