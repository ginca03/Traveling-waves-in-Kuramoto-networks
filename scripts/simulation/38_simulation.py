...
but with zero-lag delay.

Usage
-----
    python 38_simulation.py "configuration/your_configuration_file.yaml" simulation_idx
...
# Zero Fiber Lengths
# ---------------------
zero_lengths =  np.zeros_like(lengths)
...
# save data
np.save(os.path.join(data_path, f"38_simulations/38_simulation_{simulation_id}.npy"), phase)