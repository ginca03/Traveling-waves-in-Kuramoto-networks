...
#SBATCH --job-name=40_analysis_ef_ccc
...
# python script
PYTHONSCRIPT="scripts/analysis/40_analysis_ef_ccc.py"
CONFIGPATH="configuration/40_configuration.yaml"
CONFIGPATHANALYSIS="configuration/40_analysis_ef_configuration.yaml"
