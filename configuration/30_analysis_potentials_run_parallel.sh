...
#SBATCH --job-name=30_analysis_potentials_waves
...
CONFIGPATH="configuration/30_configuration.yaml"
CONFIGPATHANALYSIS="configuration/30_analysis_configuration.yaml"
