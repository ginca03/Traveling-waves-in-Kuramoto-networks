...
#SBATCH --job-name=38_analysis_potentials_waves
...
CONFIGPATH="configuration/38_configuration.yaml"
CONFIGPATHANALYSIS="configuration/38_analysis_configuration.yaml"
