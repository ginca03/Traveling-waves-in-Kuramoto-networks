...
#SBATCH --job-name=51_analysis_potentials_waves
...
CONFIGPATH="configuration/51_configuration.yaml"
CONFIGPATHANALYSIS="configuration/51_analysis_configuration.yaml"
