...
#SBATCH --job-name=34_analysis_waves
...
CONFIGPATHSIMULATION="configuration/34_configuration.yaml"
CONFIGPATHANALYSIS="configuration/34_analysis_configuration.yaml"
