...
#SBATCH --job-name=31_analysis_potentials_waves
...
CONFIGPATH="configuration/31_configuration.yaml"
CONFIGPATHANALYSIS="configuration/31_analysis_configuration.yaml"
