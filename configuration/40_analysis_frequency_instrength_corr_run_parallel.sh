...
#SBATCH --job-name=40_analysis_frequency_instrength_corr
...
# python script
PYTHONSCRIPT="scripts/analysis/40_analysis_frequency_instrength_corr.py"
CONFIGPATH="configuration/40_configuration.yaml"
CONFIGPATHANALYSIS="configuration/40_analysis_frequency_instrength_corr_configuration.yaml"
